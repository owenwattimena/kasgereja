...
<head>
    ...
    <title>SISFO KAS JEMAAT ELOHIM LATTA</title>
	<!-- BOOTSTRAP STYLES-->
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="halaman_klasis.php">Hello, <b><?= $_SESSION['username'] ?></b></a> 
            </div>
  <div style="color: white;
padding: 15px 50px 5px 50px;
float: right;
font-size: 16px;"> SISTEM INFORMASI KAS & ASET JEMAAT ELOHIM LATTA&nbsp; 
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a  href="halaman_klasis.php"><i class="glyphicon glyphicon-home"></i> DASHBOARD</a>
