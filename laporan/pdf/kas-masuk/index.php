...
$sql = $koneksi->query("SELECT k.kode, k.no_acc, k.tgl, k.keterangan, k.jumlah, kk.kode_kas FROM kas AS k
...
// Output laporan PDF
$dompdf->stream("laporan_kas_masuk.pdf", array("Attachment" => false));
exit(0);