...
<head>
    <title>LAPORAN REKAP KAS MASUK - KELUAR</title>
...
<body>
    ...
    <hr>
    <h2>LAPORAN REKAP KAS MASUK - KELUAR PERIODE {{mulai}} s/d {{selesai}}</h2>
    ...
    <div class="footer">
        GEPAM BAGUALA PASSO - LAPORAN REKAP KAS MASUK - KELUAR <span style="float:right; margin-right:60px">Hal. <span class="pagenum"></span></span>
    </div>
</body>
