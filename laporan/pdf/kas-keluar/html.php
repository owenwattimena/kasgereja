...
<body>
    ...
    <hr>
    <h2>LAPORAN KAS KELUAR PERIODE {{mulai}} s/d {{selesai}}</h2>
    ...
    <div class="footer">
        GEPAM BAGUALA PASSO - LAPORAN KAS KELUAR <span style="float:right; margin-right:60px">Hal. <span class="pagenum"></span></span>
    </div>
</body>
